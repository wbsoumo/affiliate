...
<aside class="main-sidebar sidebar-light-primary elevation-1">
    ...
    <a href="dashboard.php" class="brand-link pl-3 d-flex align-items-center justify-content-between" style="text-decoration: none;">
        <span class="brand-text d-flex align-items-center">
            <i class="fas fa-rocket text-primary mr-2" style="font-size: 1.1rem;"></i>
    ...
    <div class="sidebar">
        <nav class="mt-3">
            <ul class="nav nav-sidebar flex-column nav-child-indent" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <li class="nav-item">
                    <a href="clicks.php" class="nav-link <?= ($currentPage == 'clicks.php') ? 'active' : '' ?>">
                ...
                <li class="nav-item">
                    <a href="link-builder.php" class="nav-link <?= ($currentPage == 'link-builder.php') ? 'active' : '' ?>">
    ...
    <div class="sidebar-footer-profile">
        <div class="user-info">
            ...
            <div class="user-meta">
                <div class="user-name"><?= htmlspecialchars($affiliateName) ?></div>
                <div class="user-role">Affiliate</div>
            </div>
        </div>
