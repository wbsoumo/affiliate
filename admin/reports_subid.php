...
<head>
    ...
    <title>SubID Report | Taskbazi</title>
    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0"><i class="fas fa-chart-bar text-primary mr-2"></i>SubID Performance (sub1)</h1>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="dashboard.php">Home</a></li>
                            <li class="breadcrumb-item active">SubID Report</li>
                        </ol>
                    </div>
                </div>
            </div>
        ...
        <div class="content">
            <div class="container-fluid">
                ...
                <div class="card card-dashboard">
                    ...
                    <div class="card-body">
                        <form method="get" class="form-inline">
                            ...
                            <?php if ($from || $to): ?>
                                <a href="reports_subid.php" class="btn btn-default font-weight-bold ml-2">Clear</a>
                            <?php endif; ?>
                        </form>
                    </div>
                </div>
                ...
                <div class="card card-dashboard">
                    <div class="card-header">
                        <h3 class="card-title font-weight-bold">SubID Performance</h3>
                    </div>
                            ...
                            <table class="table table-hover table-striped mb-0">
                                ...
                                <tbody>
                                    ...
                                    <?php else: ?>
                                        ...
                                        ?>
                                            <tr>
                                                <td class="font-weight-bold"><code><?= htmlspecialchars($r['sub1']) ?></code></td>
                                                <td><?= number_format($r['clicks']) ?></td>
                                                <td><?= number_format($r['conversions']) ?></td>
                                                <td class="text-success font-weight-bold">$<?= number_format($r['payout'], 2) ?></td>
                                                <td class="font-weight-bold text-info"><?= number_format($cr, 2) ?>%</td>
                                            </tr>
                                        <?php endforeach; ?>
                                    <?php endif; ?>
                                </tbody>
