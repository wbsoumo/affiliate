...
$stmt = $pdo->prepare("
    ...
    WHERE o.tenant_id = " . current_tenant_id() . " AND o.offer_id = :offer_id AND o.advertiser_id = :advertiser_id
    GROUP BY o.offer_id
");
    ...
    if ($title === '' || $campaignUrl === '') {
        ...
        $stmt = $pdo->prepare("
            UPDATE offers SET
                ...
                updated_at = NOW()
            WHERE tenant_id = " . current_tenant_id() . " AND offer_id = :offer_id AND advertiser_id = :advertiser_id
        ");
...
<head>
    ...
    <title>Edit Campaign | Advertiser Panel | Taskbazi</title>
            ...
            <div class="container-fluid">
                ...
                <div class="postback-info">
                    ...
                    <div class="mt-2 small">
                        ...
                        <code>https://taskbazi.xyz/postback?token=<?php echo $offer['postback_token']; ?>&click_id={click_id}&payout={payout}</code>
                    </div>
                </div>
                <?php endif; ?>
